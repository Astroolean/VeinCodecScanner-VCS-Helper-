...
class App(ctk.CTk):
    def __init__(self):
        ...
        self.items = None  # (ep_num, path) for TV
        self.season = 1
        self.mode = "tv"   # "tv" or "movie"
        ...
        header = ctk.CTkLabel(
            self,
            text="Folder → auto-detect TV season or movie → OCD names",
    ...
    def build_tv_preview(self, videos):
        """Preview renaming for a TV season folder."""
